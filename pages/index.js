...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-5 dark:bg-gray-900 md:px-20 lg:px-20">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="mx-auto bg-gradient-to-b from-blue-500 rounded-full min-w-40 h-80 relative overflow-hidden mt-20 md:h-96 md:w-96">
